...
public class DAOServicioInmobiliario 
{
	...
	public ArrayList<ServicioInmobiliario> getServicioInmobiliarios() throws SQLException, Exception {
		...
		String sql = String.format("SELECT * FROM %1$s.ServicioInmobiliarioES WHERE ROWNUM <= 50", USUARIO);
	 ...
	 * @throws Exception Si se genera un error dentro del metodo.
	 */
	public ServicioInmobiliario findServicioInmobiliarioById(Long id) throws SQLException, Exception 
	{
	...
	public void deleteServicioInmobiliario(ServicioInmobiliario servicioInmobiliario) throws SQLException, Exception {
		...
		String sql = String.format("DELETE FROM %1$s.APARTAMENTO WHERE ID = %3$d", USUARIO, servicioInmobiliario.getId());
